...
$.when(
	...
	.done(
		function(result1, result2, result3)
    	{
            ...
            $("#femenino").append("<h3><a href='./product-list.html?categoryId=" + $.base64('encode', '1') + "'>&gt;Femenino&lt;</a></h3>");
            $("#masculino").append("<h3><a href='./product-list.html?categoryId=" + $.base64('encode', '2') + "'>&gt;Masculino&lt;</a></h3>");
